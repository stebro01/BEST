-- DROP VIEW IF EXISTS "main"."patient_list";
...
LEFT JOIN USER_PATIENT_LOOKUP ON
    USER_PATIENT_LOOKUP.PATIENT_NUM = PATIENT_DIMENSION.PATIENT_NUM AND
    USER_PATIENT_LOOKUP.IMPORT_DATE = PATIENT_DIMENSION.IMPORT_DATE
