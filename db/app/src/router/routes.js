...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'visits', name: 'DBQueries_PatientView', component: () => import('src/pages/DBQueries/DBQueries_PatientView.vue'), beforeEnter: beforeEnterFuncAll },
      ...
      { path: 'visits_old/observation/import', name: 'Observation_Import', component: () => import('src/pages/visits/Edit_Import.vue'), beforeEnter: beforeEnterFuncAll },
      { path: 'visits_old/observation/import/raw:FILE_PATH', name: 'Observation_Import_RAW', component: () => import('src/pages/visits/Edit_Import_RAW.vue'), beforeEnter: beforeEnterFuncAll },
